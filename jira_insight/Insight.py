...
if __name__ == "__main__":
    ...
    test_insight = Insight(
        "https://projektportal.dvag.com/jira",
        auth=("e13itjw", "brittle kid unlace spark MG42"),
    )
    test_object_schema = InsightObjectSchema(test_insight, 12)
    cats = test_object_schema.search_iql(
        'objectType in objectTypeAndChildren("Mobile Device")'
    )
    pass
